...
async function speakText(text){
  ...
  try{
    ...
    if('speechSynthesis' in window){window.speechSynthesis.cancel();const u=new SpeechSynthesisUtterance(plainText(text));u.lang='en-US';u.rate=.95;const voices=window.speechSynthesis.getVoices();u.voice=voices.find(v=>/^en(-|_)/i.test(v.lang))||null;window.speechSynthesis.speak(u);}
  }
}
