...
async function speakText(text){
  ...
  try{
    ...
    if('speechSynthesis' in window){window.speechSynthesis.cancel();const u=new SpeechSynthesisUtterance(plainText(text));u.rate=.95;window.speechSynthesis.speak(u);}
  }
}
