...
The lesson media upload path is versioned as `2026-09-14-mediafix6`. After deploying, open `/api/media-fix-version` while logged out; it should return JSON containing that exact version. If it does not, Render is serving an older deployment.
