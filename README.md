...
The Render-ready admin portal uses MongoDB-backed sessions with proxy-aware secure cookies and does not redirect an authenticated administrator to the login page merely because a non-authentication admin data request temporarily fails.
