...
The AI Tutor now uses English as its primary language. It answers in clear English by default, the speech recognition listens in `en-US`, and generated speech is instructed to use natural English. Students can still explicitly request another language.
