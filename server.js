...
const MEDIA_FIX_VERSION = "2026-09-21-chat-media8-direct-cloudinary-media";
...
async function start() {
  ...
  async function streamChatAttachment(req, res, messageId, disposition = "inline") {
    ...
    if (disposition === "inline" && (attachment.kind === "video" || attachment.kind === "audio") && attachment.publicId) {
      try {
        mediaUrl = attachment.kind === "video"
          ? cloudinary.url(attachment.publicId, {
              secure: true, resource_type: "video", format: "mp4",
              transformation: [{ video_codec: "h264", audio_codec: "aac" }]
            })
          : cloudinary.url(attachment.publicId, {
              secure: true, resource_type: "video", format: "mp3",
    ...
    if (disposition === "inline" && (attachment.kind === "video" || attachment.kind === "audio") && mediaUrl) {
    ...
    const normalizedMime = disposition === "inline" && attachment.kind === "video" ? "video/mp4"
      : disposition === "inline" && attachment.kind === "audio" ? "audio/mpeg"
      : null;
