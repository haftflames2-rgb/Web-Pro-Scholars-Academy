  ...
  async function streamChatAttachment(req, res, messageId, disposition = "inline") {
    ...
    const mime = attachment.kind === "document"
      ...
      : attachment.kind === "image"
        ? (attachment.mime || upstream.headers.get("content-type") || "image/*")
        : attachment.kind === "audio"
          ? (attachment.mime || upstream.headers.get("content-type") || "audio/webm")
          : (attachment.mime || upstream.headers.get("content-type") || "video/mp4");
