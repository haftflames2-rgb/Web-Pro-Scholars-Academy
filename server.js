...
async function start() {
  ...
  async function streamChatAttachment(req, res, messageId, disposition = "inline", forceOriginalMedia = false) {
    ...
    // Voice notes recorded by WPS Chat are deliberately stored as WAV. Keep
    // that original WAV for playback instead of asking Cloudinary to create
    // an MP3 derivative. WAV is broadly supported by Android Chrome and this
    // removes the webm/MP3/container ambiguity from voice messages.
