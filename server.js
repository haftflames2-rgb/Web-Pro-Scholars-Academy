...
const MEDIA_FIX_VERSION = "2026-09-20-chat-media5-full-stream";
...
async function start() {
  ...
  async function streamChatAttachment(req, res, messageId, disposition = "inline") {
    ...
    // Stream the complete Cloudinary object. Some mobile browsers request a
    // tiny initial Range and can stop after that first chunk when a proxy
    // changes the upstream response semantics. A complete 200 response avoids
    // that failure while still streaming the bytes instead of buffering them.
